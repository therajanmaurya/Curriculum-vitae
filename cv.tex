...
\begin{entrylist}
  \entry
    ...
    % App fetch the news in app using web-api and show in beautiful manner and saving data to sdcard to use in offline mode , Full App in Material design.
    }
  ...
  \entry
    ...
    % This app is open source, source code can be found at above link\\
